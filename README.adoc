--- Email to gmail
https://myaccount.google.com/lesssecureapps= Spring-Boot Camel XML QuickStart
...
AMQ:
Use VM  broker (vm://broker-amq-1-zxrtj:61616)
Put AMQ user name password on User preference icon on top that you see after clicking java console to view queue
